...
SETTINGS = dict(
    ...
    #TODO remove nx,ny if they are not used in the model?
    # nx                      = Setting(10, int, "Grid points in zonal direction"),
    # ny                      = Setting(10, int, "Grid points in meridional direction"),
