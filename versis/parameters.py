...
# latent heat constants of water [J/kg]
...
cpAir = 1005    # heat capacity of air [J/kgK]
...
# old default for constant freezing point #TODO implement testing flag?
#       or make a new document with all the changes that need to be done for testing...
#       thats probably cooler
